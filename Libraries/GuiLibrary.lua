...
if shared.VapeExecuted then
	local VERSION = "4.10"..(shared.VapePrivate and " PRIVATE" or "").." "..readfile("nonsense/Developer/commithash.txt"):sub(1, 6)
	...
	local vapeAssetTable = {
		...
		["nonsense/assets/DiscordIcon.png"] = "rbxassetid://13546311177",
	...
	searchbaricon.Image = downloadVapeAsset("nonsense/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = downloadVapeAsset("nonsense/assets/WindowBlur.png")
	...
	searchbaricon2.Image = downloadVapeAsset("nonsense/assets/LegitModeIcon.png")
	...
	LegitModulesExitButton.Image = downloadVapeAsset("nonsense/assets/ExitIcon1.png")
	...
	LegitModulesFrameShadow.Image = downloadVapeAsset("nonsense/assets/WindowBlur.png")
	...
	LegitModulesFrameIcon.Image = downloadVapeAsset("nonsense/assets/ProfilesIcon.png")
	...
	hoverboxshadow.Image = downloadVapeAsset("nonsense/assets/WindowBlur.png")
	...
	GuiLibrary.LoadSettings = function(customprofile)
		if isfile("nonsense/Profiles/GUIPositions.vapeprofile.txt") and game.GameId == 2619619496 then
			writefile("nonsense/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("nonsense/Profiles/GUIPositions.vapeprofile.txt"))
			if delfile then delfile("nonsense/Profiles/GUIPositions.vapeprofile.txt") end
		end
		if shared.VapePrivate then
			if isfile("vapeprivate/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") == false and isfile("nonsense/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") then
				writefile("vapeprivate/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("nonsense/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt"))
			end
			if isfile("vapeprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") == false and isfile("nonsense/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") then
				writefile("vapeprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt", readfile("nonsense/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt"))
			end
		end
		...
		if shared.VapePrivate then
			if isfile("vapeprivate/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") == false and isfile("nonsense/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") then
				writefile("vapeprivate/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt", readfile("nonsense/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt"))
			end
		end
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		windowshadow.Image = downloadVapeAsset("nonsense/assets/WindowBlur.png")
		...
		windowlogo1.Image = downloadVapeAsset("nonsense/assets/VapeLogo1.png")
		...
		windowlogo2.Image = downloadVapeAsset("nonsense/assets/VapeLogo2.png")
		...
		settingswheel.Image = downloadVapeAsset("nonsense/assets/SettingsWheel1.png")
		...
		discordbutton.Image = downloadVapeAsset("nonsense/assets/DiscordIcon.png")
		...
		settingsexit.Image = downloadVapeAsset("nonsense/assets/ExitIcon1.png")
		...
		overlaysicon.Image = downloadVapeAsset("nonsense/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = downloadVapeAsset("nonsense/assets/ExitIcon1.png")
		...
		overlaysbutton.Image = downloadVapeAsset("nonsense/assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = downloadVapeAsset("nonsense/assets/BackIcon.png")
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = downloadVapeAsset("nonsense/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = downloadVapeAsset("nonsense/assets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = downloadVapeAsset("nonsense/assets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = downloadVapeAsset("nonsense/assets/SliderButton1.png")
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindtext2.Image = downloadVapeAsset("nonsense/assets/BindBackground.png")
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = downloadVapeAsset("nonsense/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = downloadVapeAsset("nonsense/assets/ColorSlider1.png")
			...
			sliderexpand.Image = downloadVapeAsset("nonsense/assets/HoverArrow3.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = downloadVapeAsset("nonsense/assets/HoverArrow4.png")
			end)
			...
			sliderapi["SetValue"] = function(hue, sat, val)
				...
				sat = sat or 0.96
				val = val or 0.52
				slider3.Image = ((sliderapi["RainbowValue"] or sliderapi["Custom"]) and downloadVapeAsset("nonsense/assets/ColorSlider2.png") or downloadVapeAsset("nonsense/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and downloadVapeAsset("nonsense/assets/RainbowIcon2.png") or downloadVapeAsset("nonsense/assets/RainbowIcon1.png"))
	...
	GuiLibrary["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = downloadVapeAsset("nonsense/assets/PinButton.png")
		...
		optionsbutton.Image = downloadVapeAsset("nonsense/assets/MoreButton3.png")
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = downloadVapeAsset("nonsense/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = downloadVapeAsset("nonsense/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = downloadVapeAsset((argstable["Name"] == "ProfilesList" and "nonsense/assets/TextBoxBKG2.png" or "nonsense/assets/TextBoxBKG.png"))
				...
				textGuiLibrary["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textGuiLibrary["ObjectList"]) do
						...
						deletebutton.Image = downloadVapeAsset("nonsense/assets/AddRemoveIcon1.png")
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = downloadVapeAsset("nonsense/assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = downloadVapeAsset("nonsense/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	GuiLibrary["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = downloadVapeAsset("nonsense/assets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = downloadVapeAsset("nonsense/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = downloadVapeAsset("nonsense/assets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = downloadVapeAsset("nonsense/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = downloadVapeAsset("nonsense/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["NPCs"] = windowapi["CreateButton"]({
					...
					["Icon"] = "nonsense/assets/TargetIcon2.png",
					["IconSize"] = 12,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Peaceful"] = windowapi["CreateButton"]({
					...
					["Icon"] = "nonsense/assets/TargetIcon3.png",
					["IconSize"] = 16,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Neutral"] = windowapi["CreateButton"]({
					...
					["Icon"] = "nonsense/assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = downloadVapeAsset("nonsense/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = downloadVapeAsset("nonsense/assets/SliderArrow1.png")
	...
	GuiLibrary["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = downloadVapeAsset("nonsense/assets/SettingsWheel2.png")
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, textService:GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = downloadVapeAsset("nonsense/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = downloadVapeAsset("nonsense/assets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = downloadVapeAsset("nonsense/assets/HoverArrow.png")
			end)
	...
	GuiLibrary["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = downloadVapeAsset("nonsense/assets/NotificationBackground.png")
		...
		frame2.ZIndex = 2
		frame2.Image = downloadVapeAsset("nonsense/assets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = downloadVapeAsset(customicon and "nonsense/"..customicon or "nonsense/assets/InfoNotification.png")
