...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		assert(betterisfile("nonsense/"..scripturl), "File not found : nonsense/"..scripturl)
		return readfile("nonsense/"..scripturl)
	else
		local res = game:HttpGet("https://raw.githubusercontent.com/OuterScripts/Nonsense/main/"..scripturl, true)
		assert(res ~= "404: Not Found", "File not found : nonsense/"..scripturl)
		return res
	end
end
